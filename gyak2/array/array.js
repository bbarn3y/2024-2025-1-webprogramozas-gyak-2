...
const atLeast22YearsOld = undefined;

// Az egyetlen 20 év alatti személy
const under20 = undefined;

// Mindenki 40 év alatti?
const everyoneUnder40 = undefined;

// Legöregebb személy
const oldestPerson = undefined;

// Az első bicikliző indexe a tömbben
const firstCyclerIndex = undefined;

// ABC-rendben a 3. személy
const thirdPerson = undefined;

// Szeretnek LEGOzni
const likesLEGO = undefined;

// Hobbik átlagos száma
const averageHobbyCount = undefined;

// Hobbik egyedi listája
const uniqueHobbies = undefined;

// Egyedi keresztnevek
const uniqueNames = undefined;
